...
- **Estimativa de Tempo de Quebra** — exibe em tempo real o tempo estimado para quebrar a senha por força bruta, alimentado pelo motor de entropia do `zxcvbn` (ex: _"Tempo estimado para quebrar: 3 séculos"_).
